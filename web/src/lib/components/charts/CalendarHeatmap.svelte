<script lang="ts">
  ...
  export let title = 'Calendar heatmap';
  ...
  function renderChart(): void {
    disposeChart(chart);
    chart = host ? mountChart(host, 'calendar_heatmap', series, stale) : null;
  }
...
<section class="chart-frame" data-chart-type="calendar_heatmap" aria-label={title} role="img">

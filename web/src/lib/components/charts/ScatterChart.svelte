<script lang="ts">
  ...
  export let title = 'Scatter chart';
  ...
  function renderChart(): void {
    disposeChart(chart);
    chart = host ? mountChart(host, 'scatter', series, stale) : null;
  }
...
<section class="chart-frame" data-chart-type="scatter" aria-label={title} role="img">
